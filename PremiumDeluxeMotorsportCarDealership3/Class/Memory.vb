Public Class Memory
    ...
    Private _customprimarycolor As Drawing.Color
    Public Property CustomPrimaryColor() As Drawing.Color
        Get
    ...
    Private _customsecondarycolor As Drawing.Color
    Public Property CustomSecondaryColor() As Drawing.Color
        Get
            Return _customsecondarycolor
        End Get
        Set(value As Drawing.Color)
    ...
    Private _isprimarycolorcustom As Boolean
    Public Property IsPrimaryColorCustom() As Boolean
        Get
            Return _isprimarycolorcustom
        End Get
        Set(value As Boolean)
            _isprimarycolorcustom = value
        End Set
    End Property

    Private _issecondarycolorcustom As Boolean
    Public Property IsSecondaryColorCustom() As Boolean
        Get
            Return _issecondarycolorcustom
        End Get
        Set(value As Boolean)
            _issecondarycolorcustom = value
        End Set
    End Property
End Class
